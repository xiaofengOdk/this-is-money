...
<link href="/static/index/css/jquery.slideBox.css" rel="stylesheet" type="text/css" />
<script src="/static/index/js/jquery.slideBox.min.js" type="text/javascript"></script>
...
<div class="container container_col">
    ...
    <div class="indnews">
      <div class="news-pic">
        <div id="newspic" class="slideBox">
          <ul class="items">
            <li><a href="#" title="本会召开第一届第一次主任会议和委员会议1"><img src="/static/index/upload/newsimg.jpg"></a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="fwzn">
    ...
    <div class="iconlist"> <a href="#" class="icon1">
      <div class="pic"><img src="/static/index/images/zhinan01.png" /></div>
      <p>仲裁须知</p>
      </a>
      <a href="#" class="icon1">
      <div class="pic"><img src="/static/index/images/zhinan06.png" /></div>
      <p>受案范围</p>
      </a>
       <a href="#" class="icon2">
      <div class="pic"><img src="/static/index/images/zhinan02.png" /></div>
      <p>立案提交材料</p>
      </a> <a href="#" class="icon3">
      <div class="pic"><img src="/static/index/images/zhinan03.png" /></div>
      <p>财产及证据保全</p>
      </a> <a href="#" class="icon5">
      <div class="pic"><img src="/static/index/images/zhinan05.png" /></div>
      <p>仲裁程序</p>
      </a> <a href="#" class="icon6">
      <div class="pic"><img src="/static/index/images/zhinan04.png" /></div>
      <p>仲裁条款</p>
      </a> <a href="#" class="icon7">
      <div class="pic"><img src="/static/index/images/zhinan07.png" /></div>
      <p>常用文书</p>
      </a> </div>
  </div>
  <div class="col-box">
  ...
  <div class="col-box">
    <div class="col-2-l">
      ...
      <div class="list"> 
        <div class="ct">
          <a href="#" class="color_bj color-1"><div class="pic"><img src="/static/index/images/zxfw1.png" /></div><p>注册登记</p></a>
        </div>
        <div class="ct">
          <a href="#" class="color_bj color-2"><div class="pic"><img src="/static/index/images/zxfw2.png" /></div><p>在线立案</p></a>
        </div>
        <div class="ct">
          <a href="#" class="color_bj color-3"><div class="pic"><img src="/static/index/images/zxfw3.png" /></div><p>在线审批</p></a>
        </div>
        <div class="ct">
          <a href="#" class="color_bj color-4"><div class="pic"><img src="/static/index/images/zxfw4.png" /></div><p>在线咨询</p></a>
        </div>
        <div class="ct">
          <a href="#" class="color_bj color-5"><div class="pic"><img src="/static/index/images/zxfw5.png" /></div><p>在线调解</p></a>
        </div>
        <div class="ct">
          <a href="#" class="color_bj color-6"><div class="pic"><img src="/static/index/images/zxfw6.png" /></div><p>在线查询</p></a>
        </div>
        <div class="ct last">
          <a href="#" class="color_bj color-7"><div class="pic"><img src="/static/index/images/zxfw7.png" /></div><p>电子送达</p></a>
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
  ...
  <div class="col-box">
    <div class="col-2-r">
      ...
      <div class="tit" style="margin-left:420px; background: url(/static/index/images/jsq2.png) 0 9px no-repeat;">费用速算</div>
      <div class="clearfix"></div>
      <div class="sfbox">
      	<div class="gsht">
...
<script src="/static/index/js/Tabs.js"></script> 
<script type="text/javascript">
	$(function() {
		$("#link").rTabs({
			bind : 'hover',
...
<script type="text/javascript" src="/static/index/vue/vue.js"></script>
<script type="text/javascript"> 
    var vm =new Vue({
      el : "#money",
      data:{
